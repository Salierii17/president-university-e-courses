...
<body class="flex">
<div class="inset-y-0 left-0 w-60 bg-gray-800 text-white mr-36 ">
        <?php
    ...
    <div class="flex-1 bg-white p-10 ml-40">
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<div class='topic'>
                                        <div class='topic-header' onclick=\"toggleTopic('topic$topic_id-content')\">
                                            <h3>Topic $topic_number - $topic_name</h3>    
                                ...
                                if ($summary_title) {
                                    echo "<a href='summary.php?topic_id=$topic_id' class='topic-item'>
                                                <span>Summary</span>
                                ...
                                if ($quiz_name) {
                                    echo "<a href='quiz.php?topic_id=$topic_id' class='topic-item'>
                                                <span>Quiz</span>
